...
export default function HandsFreeScreen(){
  ...
  function isReadFullListCommand(
    ...
    return (
      ...
      ||
      clean.includes("lies meine ganze liste")
      ||
      clean.includes("lies alle artikel")
    );
  ...
  function isReadRemainingListCommand(
    ...
    return (
      ...
      ||
      clean.includes("lies meine liste")
      ||
  ...
  async function addItems(
    ...
    for(const spokenName of names){
      ...
      if(existingItem){
        ...
        addedMessages.push(
          `${existingItem.name} increased to ${nextQuantity}`
        );
      ...
      <View style={styles.instructionsCard}>
        ...
        <View style={styles.instructionDetails}>
          ...
          <Text style={styles.instructionText}>
            Say “What’s left?”, “Read my list” or “Read my full list”.
          </Text>
